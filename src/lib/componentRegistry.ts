...
export const componentRegistry: ComponentDef[] = [
  ...
  // Sections
  { type: 'hero', label: 'Hero', category: 'sections', icon: 'Layout', defaultProps: { heading: 'Build Something Amazing', subheading: 'Create stunning websites without writing a single line of code.', buttonText: 'Get Started', url: '/', secondaryButtonText: '', buttonColor: '#7C3AED', bgColor: '#0A0A0A', textColor: '#FFFFFF', accentColor: '#7C3AED', bgImage: '', textAlign: 'center', paddingY: '100px' } },
  { type: 'features', label: 'Features', category: 'sections', icon: 'LayoutGrid', defaultProps: { heading: 'Features', items: [{ title: 'Fast', desc: 'Lightning-fast performance' }, { title: 'Secure', desc: 'Built-in security' }, { title: 'Scalable', desc: 'Grows with you' }], bgColor: '#111111', textColor: '#FFFFFF', accentColor: '#7C3AED', bgImage: '' } },
  { type: 'testimonial', label: 'Testimonial', category: 'sections', icon: 'Quote', defaultProps: { quote: '"This product changed everything for our team."', author: 'Jane Doe', role: 'CEO at Acme', bgColor: '#0F0F0F', textColor: '#FFFFFF', accentColor: '#7C3AED', bgImage: '' } },
  { type: 'cta', label: 'CTA', category: 'sections', icon: 'Megaphone', defaultProps: { heading: 'Ready to get started?', subheading: 'Join thousands of happy customers.', buttonText: 'Start Free Trial', url: '/', buttonColor: '#7C3AED', bgColor: '#0A0A0A', textColor: '#FFFFFF', accentColor: '#7C3AED', bgImage: '' } },
  { type: 'stats', label: 'Stats', category: 'sections', icon: 'BarChart3', defaultProps: { items: [{ value: '10K+', label: 'Users' }, { value: '99.9%', label: 'Uptime' }, { value: '24/7', label: 'Support' }], bgColor: '#0A0A0A', textColor: '#FFFFFF', accentColor: '#7C3AED', bgImage: '' } },
  { type: 'pricing', label: 'Pricing', category: 'sections', icon: 'DollarSign', defaultProps: { heading: 'Simple Pricing', plans: [{ name: 'Starter', price: '$9', features: ['1 Site', '1GB Storage', 'Email Support'], ctaText: 'Get Started', url: '/' }, { name: 'Pro', price: '$29', features: ['10 Sites', '10GB Storage', 'Priority Support'], highlighted: true, ctaText: 'Get Started', url: '/' }, { name: 'Enterprise', price: '$99', features: ['Unlimited', '100GB Storage', '24/7 Support'], ctaText: 'Contact Us', url: '/contact' }], bgColor: '#111111', textColor: '#FFFFFF', accentColor: '#7C3AED', bgImage: '' } },
